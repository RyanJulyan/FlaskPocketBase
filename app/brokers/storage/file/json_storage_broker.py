...
class JsonStorageBroker(IStorageBroker):
  ...
  def create(self, file_path: str, data: Dict[Any, Any], *args: Any, **kwargs: Any):
    with open(file_path, 'w') as json_file:
      json.dump(data, json_file, *args, **kwargs)

  def read(self, file_path: str, *args: Any, **kwargs: Any):
    with open(file_path, 'r') as json_file:
      data = json.load(json_file, *args, **kwargs)
    return data

  def update(self, file_path: str, data: Dict[Any, Any], *args: Any, **kwargs: Any):
